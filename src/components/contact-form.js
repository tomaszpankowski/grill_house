...
class ContactForm extends Component {
    ...
    render() {
        return (
            <Container fluid className={"contact-s2 align-items-center px-0 py-5  border-top border-warning d-flex minh-50vh " + this.props.classExt}>
                <Row className="mx-auto text-center w-100">
                    <Col xs={11} md={6} className="mx-auto p-0 d-flex align-items-center">
                        <Form className="text-start w-100 border border-dark p-4 rounded bg-warning opacity-9 shadow text-dark fw-bold"
                            autoComplete="off"
                            method="POST">
