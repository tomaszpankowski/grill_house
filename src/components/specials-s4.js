...
class SpecialsS4 extends Component{
    render(){
        return(    
            <Container fluid className="specials-s4 d-flex minh-50vh align-items-center py-5 border-top border-warning bg-secondary">
                <Row className="mx-0 w-100 px-3 text-shadow">
                    ...
                    <Col md={1} className="d-none d-md-block mx-auto">
                        <div class="border-warning border-start mx-auto h-100 w-25"></div>
                    </Col>
