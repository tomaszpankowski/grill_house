...
class LoginForm extends Component{
    ...
    render(){
        return(        
            <Container fluid className={"login-s1 align-items-center px-0 py-5 d-flex minh-100vh "+this.props.classExt}>
                <Row className="mx-auto text-start w-100 pt-5">
                    <Col xs={11} md={5} lg={4} className="mx-auto p-0 d-flex align-items-center">
                        <Form className="text-start w-100 opacity-9 border border-dark p-4 rounded bg-warning shadow text-dark fw-bold"
                            autoComplete="off"
                            method="POST">
                            ...
                            <div className="w-100 text-start py-3">
                                <p className="text-dark fw-normal">
                                    Not registered? 
                                    <Link to={this.props.backLink.href} className="text-dark fw-bold text-decoration-none">
