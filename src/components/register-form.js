            ...
            <Container fluid className={"contact-s2 align-items-center p-0 py-5 d-flex minh-100vh "+this.props.classExt}>
                <Row className="mx-auto text-start w-100 pt-5">
                    <Col xs={11} md={6} lg={5} className="mx-auto p-0 d-flex align-items-center">
                        <Form className="text-start w-100 border border-secondary p-4 rounded bg-warning shadow text-dark opacity-9 fw-bold z-index-10"
                            autoComplete="off"
                            method="POST">
                            ...
                            <Form.Group controlId="formFirst">
                                <Form.Label>First Name</Form.Label>
                                 <Form.Control type="text" 
                                    ...
                                    className="rounded-pill border-dark text-dark"
                                    maxLength="50"
                                    name="firstName"
