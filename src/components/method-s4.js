...
class MethodS4 extends Component{
    render(){
        return(    
            <Container fluid className="method-s4 d-flex minh-50vh align-items-center py-5 border-top border-warning bg-secondary">
