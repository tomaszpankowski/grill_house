...
class SpecialsS1 extends Component{
    render(){
        return(    
            <Container fluid className="specials-s1 d-flex minh-50vh align-items-center py-5 border-top border-secondary pt-5">
